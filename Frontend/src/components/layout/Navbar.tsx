...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[100] bg-white shadow-sm flex flex-col">

        {/* MAIN HEADER */}
        <div className="w-full container-wide px-3 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-6 lg:gap-8">
          {/* Logo */}
          <div className="flex-shrink-0 flex items-center justify-start">
            <Link to={ROUTES.HOME} className="flex items-center gap-2 sm:gap-6 lg:gap-10 min-w-0">
              <img
                src="/logo.png"
          ...
          <div className="hidden lg:flex flex-1 min-w-0 relative z-20">
            <form onSubmit={handleSearch} className="flex w-full border-2 border-primary-900 rounded-lg overflow-hidden bg-white shadow-xs">
              ...
              <button
                type="submit"
                className="bg-primary-900 text-white px-8 py-2.5 font-semibold hover:bg-primary-800 transition-colors flex-shrink-0"
              >
                Search
              </button>
            </form>
          ...
          <div className="hidden lg:flex flex-shrink-0 items-center justify-end gap-4 lg:gap-6 xl:gap-8">
                      ...
                      >
                        ...
                        <div className="py-1">
                          <Link
                            ...
                            className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors font-semibold"
                          >
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 border-t border-gray-100 font-semibold"
                        >
          ...
          <div className="flex lg:hidden items-center gap-1.5 sm:gap-2.5 ml-auto flex-shrink-0">
            {/* Pill Box Action Group */}
            <div className="bg-gray-50 border border-gray-200/90 rounded-2xl px-2.5 py-1.5 flex items-center gap-2.5 shadow-2xs">
              {/* Search Toggle Icon */}
              <button
                onClick={() => {
                ...
                className="p-1 text-gray-700 hover:text-primary-600 active:scale-95 transition-all flex items-center justify-center"
                aria-label="Search"
              >
                <Search size={19} />
              </button>
              ...
              >
                <Heart size={19} />
                {wishlistCount > 0 && (
                  <span className="absolute -top-1.5 -right-2 bg-yellow-400 text-gray-900 text-[10px] font-black rounded-full w-4 h-4 flex items-center justify-center border border-white">
              ...
              >
                ...
                {itemCount > 0 && (
                  <span className="absolute -top-1.5 -right-2 bg-yellow-400 text-gray-900 text-[10px] font-black rounded-full w-4 h-4 flex items-center justify-center border border-white shadow-2xs">
            ...
            <button
              ...
              className="p-2 text-gray-800 hover:bg-gray-100 rounded-xl flex items-center justify-center transition-colors active:scale-95 ml-0.5"
        ...
        <AnimatePresence>
          {isMobileSearchOpen && (
            ...
            >
              <form onSubmit={handleSearch} className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-3 py-1.5 focus-within:border-primary-600 transition-colors">
                ...
                />
                {query && (
                  <button type="button" onClick={() => setQuery('')} className="text-gray-400 hover:text-gray-600 p-0.5 flex-shrink-0">
                    <X size={16} />
                  </button>
                )}
                <button type="submit" className="flex-shrink-0 bg-primary-900 text-white text-xs font-bold px-3.5 py-1.5 rounded-lg hover:bg-primary-800 transition-colors">
                  Search
                </button>
              </form>
        ...
        <div className="hidden lg:block border-t border-gray-100">
          <div className="container-wide flex items-center">
            ...
            <div className="relative" onMouseLeave={() => setIsMegaOpen(false)}>
              <button
                className="flex items-center gap-2 bg-gray-50 hover:bg-gray-100 px-1 py-4 w-64 border-r border-gray-100 transition-colors"
            ...
            {/* Inline Nav Links */}
            <nav className="flex justify-center gap-6 px-8 flex-1">
              {[
      ...
      <div className="h-[64px] sm:h-[76px] lg:h-[136px]" />
            ...
            >
              ...
              <div className="px-5 py-2 flex flex-col gap-1">
                <button
                  ...
                  className="flex items-center justify-between px-4 py-3 rounded-2xl font-bold transition-all text-sm text-gray-800 hover:bg-gray-50 text-left w-full"
                >
