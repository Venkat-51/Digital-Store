...
const CustomerDashboard: React.FC = () => {
  ...
  const STAT_CARDS = [
    ...
    { icon: <DollarSign size={22} />, label: 'Total Spent', value: `S$${stats?.total_spent ?? '0.00'}`, color: 'from-secondary-500 to-secondary-700', to: ROUTES.ORDERS },
            ...
            {orders.results.slice(0, 5).map((order) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-black text-gray-900">S${order.total}</p>
                </div>
              </Link>
            ))}
          </div>
